...
public class UserService implements UserDetailsService, IUserService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		LOG.info( "Usuario autenticado " + user.getName() );
		LOG.info( "Usuario autenticado " + user.getLastName() );
		LOG.info( "Usuario autenticado " + user.getEmail() );
		LOG.info( "Usuario autenticado " + user.getPassword() );
		LOG.info( "Usuario autenticado " + user.getEnabled() );
